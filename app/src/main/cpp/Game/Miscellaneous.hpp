        ...
        if (obj != nullptr) {
            ...
            if (CharacterData != nullptr) {
                ...
                if (CharacterSettingsData != nullptr) {
                    if (configs::character::speed) {
                        *(float*)((uint64_t)CharacterSettingsData + string2Offset(OBFUSCATE("0x14"))) = configs::character::speedValue;
                    }
